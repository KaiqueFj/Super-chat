...
},{"./handleUserFunctions/signUp.js":"kmAUz","./handleUserFunctions/Login":"2D5hg","./handleClicks/toggleBackground.js":"1dnOt","./handleClicks/dropDownMenu.js":"2A5c6","./handleUserFunctions/updateSettings.js":"iqdDI","./handleClicks/handleUserMenuClick.js":"lvnxT","./handleUserFunctions/addUserContact.js":"8mPQ5","./handleChatFunction/userHandlers.js":"cTard","./handleChatFunction/messageHandlers.js":"gzXlC","./handleInteration/domElements.js":"6Wb4s","./handleClicks/OptionsMenu.js":"4Yy6D",".//handleUserFunctions/groupCreate.js":"fYmAq","core-js/modules/web.immediate.js":"49tUX","regenerator-runtime/runtime":"dXNgZ"}],"kmAUz":[function(require,module,exports) {
...
const toggleBackground = ()=>{
    ...
    (0, _domElementsJs.toggleBackgroundButton).on("click", function(e) {
        e.preventDefault();
        (0, _domElementsJs.html).add((0, _domElementsJs.body)).add((0, _domElementsJs.footer)).add((0, _domElementsJs.header)).add((0, _domElementsJs.main)).add((0, _domElementsJs.leftMenu)).add((0, _domElementsJs.leftMenuThumb)).add((0, _domElementsJs.leftMenuTrack)).add((0, _domElementsJs.leftMenuTrackPiece)).add((0, _domElementsJs.leftMenuCorner)).toggleClass("light-mode");
        ...
        (0, _domElementsJs.spanUsername).add((0, _domElementsJs.userNameSelected)).add((0, _domElementsJs.groupName)).toggleClass("light-mode-color-details-text");
        ...
        (0, _domElementsJs.users).add((0, _domElementsJs.groups)).toggleClass("light-mode-color-hover");
        (0, _domElementsJs.usersSelected).add((0, _domElementsJs.groupSelected)).toggleClass("light-mode usersselected");
...
parcelHelpers.export(exports, "groupSelected", ()=>groupSelected);
parcelHelpers.export(exports, "leftMenu", ()=>leftMenu);
parcelHelpers.export(exports, "leftMenuThumb", ()=>leftMenuThumb);
parcelHelpers.export(exports, "leftMenuTrack", ()=>leftMenuTrack);
parcelHelpers.export(exports, "leftMenuTrackPiece", ()=>leftMenuTrackPiece);
parcelHelpers.export(exports, "leftMenuCorner", ()=>leftMenuCorner);
...
const groupPhotoPrev = $(".form__user-photo.group-pic");
const body = $("body");
const html = $("html");
const main = $("main");
const footer = $(".footer");
...
const leftMenuThumb = $(".leftMenu::-webkit-scrollbar-thumb");
const leftMenuTrack = $(".leftMenu::-webkit-scrollbar-track");
const leftMenuTrackPiece = $(".leftMenu::-webkit-scrollbar-track-piece");
const leftMenuCorner = $(".leftMenu::-webkit-scrollbar-corner");
...
const settingsMenu = ()=>{
    ...
    (0, _helperFunctionsJs.handleEvent)((0, _domElementsJs.OpenContainerUpdateUserBtn), "click", ()=>{
...
const contactsMenu = ()=>{
    (0, _helperFunctionsJs.handleEvent)((0, _domElementsJs.settingsOpenButton), "click", ()=>{
        (0, _helperFunctionsJs.toggleClass)((0, _domElementsJs.contactsContainer), "show");
    });
    (0, _helperFunctionsJs.handleEvent)((0, _domElementsJs.createContactBtn), "click", ()=>{
        (0, _helperFunctionsJs.toggleClass)((0, _domElementsJs.contactsContainer), "show");
        (0, _helperFunctionsJs.toggleClass)((0, _domElementsJs.addContactContainer), "show");
    });
    (0, _helperFunctionsJs.handleEvent)((0, _domElementsJs.returnBtn), "click", ()=>{
        if ((0, _domElementsJs.contactsContainer).hasClass("show")) (0, _helperFunctionsJs.removeClass)((0, _domElementsJs.contactsContainer), "show");
        else if ((0, _domElementsJs.addContactContainer).hasClass("show")) (0, _helperFunctionsJs.removeClass)((0, _domElementsJs.addContactContainer), "show");
    });
};
...
parcelHelpers.export(exports, "handleEvent", ()=>handleEvent);
parcelHelpers.export(exports, "scrollToBottom", ()=>scrollToBottom);
parcelHelpers.export(exports, "createMenuItem", ()=>createMenuItem);
parcelHelpers.export(exports, "scrollToMessage", ()=>scrollToMessage);
parcelHelpers.export(exports, "createMessageContainer", ()=>createMessageContainer);
...
function handleEvent(element, eventType, callback) {
...
function createMenuItem(text, iconClass) {
    return $("<div>").text(text).addClass("menuItemContextMenu").prepend($("<i>").addClass("fa-solid " + iconClass));
}
...
function createMessageContainer(message, messageID, senderID, createdAt, userName, isGroupChat) {
    ...
    if ((0, _domElementsJs.userClientId) === senderID) {
...
function handleContextMenu(event, messageElement, senderID) {
    ...
    if (contextMenu.length) contextMenu.remove();
    else {
        const posX = event.clientX;
        const posY = $(messageElement).offset().top + $(messageElement).outerHeight() - 50;
...
function createContextMenu(posX, posY) {
    const newContextMenu = $("<div>").addClass("contextMenu").css({
        top: posY + "px",
        left: posX + "px"
    });
...
function attachContextMenuHandlers(contextMenu, messageElement, senderID) {
    ...
    deleteButton.on("click", (e)=>handleDeleteMessage(e, messageElement, contextMenu, senderID));
    editButton.on("click", (e)=>handleEditMessage(e, messageElement, contextMenu));
    copyButton.on("click", (e)=>handleCopyMessage(e, messageElement, contextMenu));
}
function handleDeleteMessage(e, messageElement, contextMenu, senderID) {
    ...
    if (senderID === (0, _domElementsJs.userClientId)) {
...
function handleEditMessage(e, messageElement, contextMenu) {
    ...
    const editInput = $("<input>").attr("type", "text").val(currentMessage).addClass("edit-messageInput");
    const editButton = $("<button>").prepend($("<i>").addClass("fa-solid fa-check")).addClass("edit-messageBtn");
    const editForm = $("<form>").append(editInput, editButton).addClass("edit-messageForm");
    ...
    editButton.on("click", (e)=>{
        ...
        if (editedMessage !== "") {
            ...
            editForm.remove();
            const messageID = messageContainer.find(".spanMessage").attr("data-message");
...
function socketListeners(socket) {
    socket.on("received-message", (message)=>{
        if (message.user !== (0, _domElementsJs.userClientId)) $(".users").each(function() {
            const roomID = (0, _domElementsJs.userClientId) + "_" + $(this).data("user-room");
...
},{"axios":"jo6P5","../handleAlertPage/alert":"hgdTX","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"49tUX":[function(require,module,exports) {
"use strict";
...
},{}]},["gTVKZ","f2QDv"], "f2QDv", "parcelRequiredad9")
