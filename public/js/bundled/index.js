...
(0, _chat.chatApplication)();

},{"@babel/polyfill":"dTCHC","./signUp":"a26Sx","./Login":"5NPXU","./toggleBackground":"9lNI6","./dropDownMenu":"ezEYc","./chat":"ljJBs"}],"dTCHC":[function(require,module,exports) {
"use strict";
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ljJBs":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "chatApplication", ()=>chatApplication);
...
const chatApplication = ()=>{
    ...
    function createMessageContainer(message, messageID, senderID, createdAt) {
        const userMessage = $("<span>").addClass("spanMessage").text(message).attr("data-message", messageID);
        ...
        const userMessageCreatedAt = $("<span>").addClass("spanCreatedAt").text(formattedTimeResult);
        ...
        messageContainer.on("contextmenu", function(event) {
            ...
            if (contextMenu.length) contextMenu.remove();
                ...
                const editButton = $("<button>").text("Edit").addClass("menuItemContextMenu");
                const deleteButton = $("<button>").text("Delete").addClass("menuItemContextMenu");
                ...
                editButton.on("click", function(e) {
                    e.preventDefault();
                    const currentMessage = $(this).closest(".messageContainer").find(".spanMessage").text();
                    const editedMessage = prompt("Edit message:", currentMessage);
                    if (editedMessage !== null && editedMessage.trim() !== "") {
                        $(this).closest(".messageContainer").find(".spanMessage").text(editedMessage);
                        const messageID = $(this).closest(".messageContainer").find(".spanMessage").attr("data-message");
        ...
        if (userClientId !== senderID) messageContainer.addClass("owner-false");
        return messageContainer;
    }
    // Function to display a message in the chat
    function displayMessageInChat(message, messageID, senderID, createdAt) {
        const messageContainer = createMessageContainer(message, messageID, senderID, createdAt);
    ...
    socket.on("getUsersMessage", async (messages)=>{
        $(".messageList").empty();
        const displayPromises = messages.map((message)=>displayMessageInChat(message.message, message._id, message.user, message.createdAt));
